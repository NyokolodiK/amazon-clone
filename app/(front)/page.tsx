...
export const metadata: Metadata = {
  ...
  description: process.env.NEXT_PUBLIC_APP_DESCRIPTION || 'Nextjs, Server components, Next auth, daisyui, zustand',
}
    ...
    <>
      <div className="w-full carousel rounded-box mt-4">
        {featuredProducts.map((product, index) => (
          <div className="carousel-item relative w-full" key={product._id} id={`slide-${index}`}>
